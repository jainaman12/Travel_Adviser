...
class updateCustomer extends JFrame implements ActionListener {
    ...
    updateCustomer(String username) {
        ...
        ImageIcon img4 = new ImageIcon(ClassLoader.getSystemResource("icons/update1.jpg"));
        ...
        l31 = new JLabel("Update your Personal Details !");
        l31.setBounds(60, 50, 420, 34);
        ...
        try {
            ...
            while(rs.next()){
                ...
                txn4.setText(rs.getString("address"));
                txn2.setText(rs.getString("idnumber"));
                String selected=rs.getString("gender");
